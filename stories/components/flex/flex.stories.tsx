      ...
      <Flex justifyContent="space-between" alignItems="center" padding="5% 5%">
        <Flex flexDirection="column" alignItems="center" width={50}>
          ...
          <p>
            ...
            mauris. Nam posuere augue metus, finibus faucibus nulla ullamcorper sed. Vivamus
            venenatis nec lorem quis scelerisque. Suspendisse at elit sed purus commodo vestibulum.
            Donec sed lorem nulla. Nam dolor urna, posuere eget maximus ac, eleifend quis nibh.
            Maecenas interdum porta metus, eu accumsan nunc facilisis nec. Nam id placerat tellus.
          </p>
          <button>Next</button>
        </Flex>
        <Flex flexDirection="column" alignItems="center" width={50}>
